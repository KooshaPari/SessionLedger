...
|---|---|---|---|---|---|
| C00 | 26/30 · partial | Profiling/race gates remain after RSS budget smoke | `audit/.lane-c00/C00.md`; `tests/memory_budget.rs`; `scripts/rss-budget-check.ps1`; `docs/ops/memory-budget.json` | Add formal concurrency checkers and allocator profiling | 2026-07-14 |
...
| C09 | 38/45 · partial | SR procedure + native smoke evidence landed; shell completions and live-daemon native parity remain | `audit/.lane-c09/C09.md`; `docs/a11y/screen-reader-smoke.md`; `scripts/record-native-webview-smoke.ps1`; `tests/visual/harness/a11y.spec.js` | Complete live-daemon native WebView parity | 2026-07-14 |
...
| PLAN-W8-B | done | Wave-23 result is 343/402 (85% B), meeting the B threshold | Independent audit-v38 result is at least 302/402 and >=75% | Hold B; pursue C11 signing implementation for higher grades | 2026-07-14 |
