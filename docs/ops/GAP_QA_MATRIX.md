...
| C09 | 31/45 · partial | Native WebView/live-data, responsive, cognitive, help, and efficiency coverage remain incomplete | `audit/.lane-c09/C09.md`; WCAG suite against all built-viewer tabs at three widths | Add responsive overflow/touch assertions and native integration evidence | 2026-07-12 |
