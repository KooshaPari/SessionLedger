...
| C08 | 29/30 · partial | Cross-language fixture parity + Python/Go/TypeScript OKF adapter stubs + production-scale corpus breadth (#368 W44-B6: 20 -> 33 fixtures via generator) landed; L76 Agent-Eval Pipeline partial (1 raw pt unpaid) | `docs/ops/cross-language-parity.md`; `scripts/cross-language-parity-check.ps1`; `adapters/typescript/okf_adapter.ts`; `adapters/go/main.go`; `audit/.lane-c08/C08.md` | Grow production-scale families | 2026-07-17 |
...
| PLAN-W8-B | done | Wave-44 closure (#368 W44-B6 corpus / #372 W44-B1 loom / #373 PERT correction) at 396/402 (98% A), held; Wave-43 -> Wave-44 result 396/402 held | Independent audit-v38 result is at least 362/402 and >=90% | Wave-45: human attestation (C04 L36 2FA) + machine L76 Agent-Eval Pipeline (C08) + L110 Tray/Menubar Client (C11); HUMAN-gated brew/winget signing (C11) + KMS/PII redaction (C02) deferred | 2026-07-23 |
