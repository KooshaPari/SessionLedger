...
| C10 | 30/36 · partial | Caption/measure typography and splash remain incomplete | `audit/.lane-c10/C10.md`; `assets/tokens.css`; `tests/visual/harness/visual.spec.js` | Add caption scale token and splash/banner | 2026-07-13 |
| C11 | 32/45 · partial | Native installer signing, channels parity, and signed clean-host install remain | `audit/.lane-c11/C11.md`; `.github/workflows/ci.yml`; `scripts/installer-lifecycle-smoke.ps1`; `docs/ops/distribution.md` | Record signing decision; signed production installer evidence | 2026-07-13 |
...
| PLAN-W8-B | done | Wave-16 result is 320/402 (80% B), meeting the B threshold | Independent audit-v38 result is at least 302/402 and >=75% | Hold B; pursue C11 signing for higher grades | 2026-07-13 |
