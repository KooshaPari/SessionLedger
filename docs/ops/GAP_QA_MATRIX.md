...
| C01 | 27/30 · partial | Quality-gate SHA pin landed; shell completions remain | `audit/.lane-c01/C01.md`; `.github/workflows/qgate.yml`; `.env.example`; `scripts/env-example-check.ps1` | Ship clap completions + richer --help examples | 2026-07-14 |
...
| C04 | 25/30 · partial | Renovate + gitleaks SARIF + branch-protection verify script landed; maintainer 2FA is unproven | `audit/.lane-c04/C04.md`; `renovate.json`; `.github/workflows/security.yml`; `docs/adr/0004-commit-signing-policy.md`; `scripts/branch-protection-check.ps1`; `docs/ops/branch-protection.md` | Human records 2FA | 2026-07-14 |
...
| C06 | 25/30 · partial | Best-effort OCI cosign+attest landed; full L3 environment isolation and verify-on-deploy remain | `scripts/repro-check.ps1`; `.github/workflows/release.yml`; `docs/ops/reproducible-builds.md` | Close environment-isolation gaps; make OCI attest release-blocking | 2026-07-14 |
...
| PLAN-W8-B | done | Wave-26 result is 356/402 (89% B), meeting the B threshold | Independent audit-v38 result is at least 302/402 and >=75% | Hold B; pursue C11 signing + published brew/winget + C04 2FA for higher grades | 2026-07-14 |
