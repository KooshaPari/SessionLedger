...
|---|---|---|---|---|---|
| C00 | 23/30 · partial | OpenAPI drift CI, cancellation, durable schema, profiling/race/RSS gates | `audit/.lane-c00/C00.md`; `docs/api/openapi.yaml`; ingest idempotency tests | Add OpenAPI drift gate; prioritize P6 hardening evidence | 2026-07-13 |
...
| C04 | 23/30 · partial | Maintainer 2FA is unproven; commit signing and dual-scanner secret policy incomplete | `audit/.lane-c04/C04.md`; `.pre-commit-config.yaml` gitleaks; org settings evidence | Human records 2FA; add optional trufflehog CI | 2026-07-13 |
...
| C10 | 29/36 · partial | Spacing/motion tokens, splash, and peripheral pane tokenization remain incomplete | `audit/.lane-c10/C10.md`; `assets/tokens.css`; theme persistence + AA tests | Tokenize live-feed chrome; add spacing/motion scales | 2026-07-13 |
...
| PLAN-W8-B | done | Wave-15 result is 316/402 (79% B), meeting the B threshold | Independent audit-v38 result is at least 302/402 and >=75% | Hold B; pursue C11 signing/clean-host install for higher grades | 2026-07-13 |
