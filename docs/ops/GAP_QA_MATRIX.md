...
| C04 | 25/30 · partial | Renovate + gitleaks SARIF landed; maintainer 2FA is unproven | `audit/.lane-c04/C04.md`; `renovate.json`; `.github/workflows/security.yml`; `docs/adr/0004-commit-signing-policy.md` | Human records 2FA; machine-verify branch protection | 2026-07-14 |
