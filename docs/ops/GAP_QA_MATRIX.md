...
|---|---|---|---|---|---|
| C00 | 30/30 · done | Blocking loom/shuttle/Miri/TSan permutation + jemalloc hard gate + partial daemon-graph loom ports landed; default-on jemalloc and full tokio broadcast graph remain | `audit/.lane-c00/C00.md`; `scripts/loom-permutation-check.ps1`; `tests/loom_model.rs`; `.github/workflows/jemalloc-hard.yml`; `scripts/jemalloc-check.ps1` | Promote default-on jemalloc; add full tokio sl-daemon broadcast/SSE graph ports | 2026-07-18 |
